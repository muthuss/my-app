    ...
    try {
        ...
        if (r.length > 0) {
            ...
            // If error, then display error
                ...
                alert("Error: Status="+v.status+" Message="+v.message);
                ...
                if (fail) {
                    try {
                        ...
                        alert("Error in error callback: "+callbackId+" = "+e1);
                    }
    ...
    if (PhoneGap.callbacks[callbackId]) {
        ...
        if (args.status === PhoneGap.callbackStatus.OK) {
            try {
                ...
                alert("Error in Success callback: "+callbackId+" = "+e);
            }
        }
...
PhoneGap.callbackError = function(callbackId, args) {
    if (PhoneGap.callbacks[callbackId]) {
        try {
            ...
            alert("Error in error callback: "+callbackId+" = "+e);
        }
